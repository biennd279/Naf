...
\begin{itemize}
	...
	\item Thông tin về xác thực: Cần được thực hiện một lần đăng nhập
	      để lấy thông tin để cung cấp đầy đủ thông tin cho ZAP Context.
...
thiết đặt tự động trong trình Wizard thay vì phải thiết lập thủ công.
